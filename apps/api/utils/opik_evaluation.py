                ...
                try:
                    ...
                    if len(items) > max_samples:
                        ...
                        for item in sampled_items:
                            item_dict = {
                                "input": getattr(item, "input", "") or item.get("input") if hasattr(item, "get") else "",
                                "expected_output": getattr(item, "expected_output", "") or (item.get("expected_output") if hasattr(item, "get") else ""),
                            }
