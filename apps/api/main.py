...
from routers import feed, workspace, agent, ingest, integrations, reels, evaluate, comments, reel_interactions, users, feed_pagination, activities
...
app.include_router(feed_pagination.router, prefix="/api/reels", tags=["reels"])  # Feed pagination FIRST
app.include_router(reels.router, prefix="/api/reels", tags=["reels"])  # Then general reels
